...
# Database: marywade
# Generation Time: 2019-03-05 00:43:30 +0000
# ************************************************************
...
# Dump of table omeka_collections
# ------------------------------------------------------------
...
# Dump of table omeka_element_sets
# ------------------------------------------------------------
...
INSERT INTO `omeka_element_sets` (`id`, `record_type`, `name`, `description`)
VALUES
...
# Dump of table omeka_element_texts
# ------------------------------------------------------------
...
INSERT INTO `omeka_elements` (`id`, `element_set_id`, `order`, `name`, `description`, `comment`)
VALUES
...
# Dump of table omeka_item_types
# ------------------------------------------------------------
...
INSERT INTO `omeka_item_types` (`id`, `name`, `description`)
VALUES
...
# Dump of table omeka_item_types_elements
# ------------------------------------------------------------
...
INSERT INTO `omeka_item_types_elements` (`id`, `item_type_id`, `element_id`, `order`)
VALUES
	(1,1,7,NULL),
	(2,1,1,NULL),
	(3,6,7,NULL),
...
INSERT INTO `omeka_options` (`id`, `name`, `value`)
VALUES
	(1,'omeka_version','2.6.1'),
	(2,'administrator_email','test@marywadefamily.org'),
	(3,'copyright',''),
	(4,'site_title','MWF Test Site'),
	(5,'author',''),
	(6,'description',''),
	...
	(31,'omeka_update','a:2:{s:14:\"latest_version\";s:6:\"2.6.1\n\";s:12:\"last_updated\";i:1551746535;}');

/*!40000 ALTER TABLE `omeka_options` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table omeka_plugins
# ------------------------------------------------------------
...
# Dump of table omeka_records_tags
# ------------------------------------------------------------
...
# Dump of table omeka_schema_migrations
# ------------------------------------------------------------
...
INSERT INTO `omeka_schema_migrations` (`version`)
VALUES
	('20100401000000'),
	('20100810120000'),
	('20110113000000'),
...
# Dump of table omeka_search_texts
# ------------------------------------------------------------
...
INSERT INTO `omeka_sessions` (`id`, `modified`, `lifetime`, `data`)
VALUES
	('6ebcolt2ipsmverantai8j6dtl',1551746534,1209600,''),
	('co415kc3mv7f4a5ar2425cv7sc',1551746535,1209600,X'44656661756C747C613A313A7B733A383A227265646972656374223B733A313A222F223B7D5A656E645F417574687C613A313A7B733A373A2273746F72616765223B693A313B7D'),
	('ek86m5sn0fkftu4fb1eh4brdpl',1551746101,1209600,''),
	('vm40u2aejkttckugtvh6e14qug',1551745975,1209600,'');

/*!40000 ALTER TABLE `omeka_sessions` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table omeka_tags
# ------------------------------------------------------------
...
INSERT INTO `omeka_users` (`id`, `username`, `name`, `email`, `password`, `salt`, `active`, `role`)
VALUES
	(1,'test','Super User','test@marywadefamily.org','4d3ccefc80e191ef0f14c762ff39a9f8ba20a1be','32585c2a77ef3a64',1,'super');

/*!40000 ALTER TABLE `omeka_users` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table omeka_users_activations
# ------------------------------------------------------------
...
INSERT INTO `wt_block` (`block_id`, `gedcom_id`, `user_id`, `xref`, `location`, `block_order`, `module_name`)
VALUES
	...
	(16,NULL,1,NULL,'main',1,'todays_events'),
	(17,NULL,1,NULL,'main',2,'user_messages'),
	(18,NULL,1,NULL,'main',3,'user_favorites'),
	(19,NULL,1,NULL,'side',1,'user_welcome'),
	(20,NULL,1,NULL,'side',2,'random_media'),
	(21,NULL,1,NULL,'side',3,'upcoming_events'),
	(22,NULL,1,NULL,'side',4,'logged_in'),
	(23,1,NULL,NULL,'main',1,'gedcom_stats'),
	(24,1,NULL,NULL,'main',2,'gedcom_news'),
	(25,1,NULL,NULL,'main',3,'gedcom_favorites'),
	(26,1,NULL,NULL,'main',4,'review_changes'),
	(27,1,NULL,NULL,'side',1,'gedcom_block'),
	(28,1,NULL,NULL,'side',2,'random_media'),
	(29,1,NULL,NULL,'side',3,'todays_events'),
	(30,1,NULL,NULL,'side',4,'logged_in');

/*!40000 ALTER TABLE `wt_block` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table wt_block_setting
# ------------------------------------------------------------
...
INSERT INTO `wt_dates` (`d_day`, `d_month`, `d_mon`, `d_year`, `d_julianday1`, `d_julianday2`, `d_fact`, `d_gid`, `d_file`, `d_type`)
VALUES
	(1,'JAN',1,1850,2396759,2396759,'BIRT','I1',1,'@#DGREGORIAN@');

/*!40000 ALTER TABLE `wt_dates` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table wt_default_resn
# ------------------------------------------------------------
...
INSERT INTO `wt_default_resn` (`default_resn_id`, `gedcom_id`, `xref`, `tag_type`, `resn`, `comment`, `updated`)
VALUES
	(1,-1,NULL,'SSN','confidential',NULL,'2019-03-05 00:32:09'),
	(2,-1,NULL,'SOUR','privacy',NULL,'2019-03-05 00:32:09'),
	(3,-1,NULL,'REPO','privacy',NULL,'2019-03-05 00:32:09'),
	(4,-1,NULL,'SUBM','confidential',NULL,'2019-03-05 00:32:09'),
	(5,-1,NULL,'SUBN','confidential',NULL,'2019-03-05 00:32:09'),
	(6,1,NULL,'SSN','confidential',NULL,'2019-03-05 00:43:02'),
	(7,1,NULL,'SOUR','privacy',NULL,'2019-03-05 00:43:02'),
	(8,1,NULL,'REPO','privacy',NULL,'2019-03-05 00:43:02'),
	(9,1,NULL,'SUBM','confidential',NULL,'2019-03-05 00:43:02'),
	(10,1,NULL,'SUBN','confidential',NULL,'2019-03-05 00:43:02');

/*!40000 ALTER TABLE `wt_default_resn` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table wt_families
# ------------------------------------------------------------
...
INSERT INTO `wt_gedcom` (`gedcom_id`, `gedcom_name`, `sort_order`)
VALUES
	(-1,'DEFAULT_TREE',0),
	(1,'MaryWadeFamilyTest',0);

/*!40000 ALTER TABLE `wt_gedcom` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table wt_gedcom_chunk
# ------------------------------------------------------------
...
INSERT INTO `wt_gedcom_chunk` (`gedcom_chunk_id`, `gedcom_id`, `chunk_data`, `imported`)
VALUES
	(1,1,X'',1);

/*!40000 ALTER TABLE `wt_gedcom_chunk` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table wt_gedcom_setting
# ------------------------------------------------------------
...
INSERT INTO `wt_gedcom_setting` (`gedcom_id`, `setting_name`, `setting_value`)
VALUES
	...
	(-1,'USE_SILHOUETTE','1'),
	(-1,'WATERMARK_THUMB','0'),
	(-1,'WEBTREES_EMAIL','webtrees-noreply@localhost'),
...
INSERT INTO `wt_individuals` (`i_id`, `i_file`, `i_rin`, `i_sex`, `i_gedcom`)
VALUES
...
INSERT INTO `wt_log` (`log_id`, `log_time`, `log_type`, `log_message`, `ip_address`, `user_id`, `gedcom_id`)
VALUES
	(1,'2019-03-05 00:32:09','config','Site preference \"INDEX_DIRECTORY\" set to \"data/\"','172.21.0.1',NULL,NULL),
	(2,'2019-03-05 00:32:09','config','Site preference \"USE_REGISTRATION_MODULE\" set to \"1\"','172.21.0.1',NULL,NULL),
	(3,'2019-03-05 00:32:09','config','Site preference \"ALLOW_USER_THEMES\" set to \"1\"','172.21.0.1',NULL,NULL),
	(4,'2019-03-05 00:32:09','config','Site preference \"ALLOW_CHANGE_GEDCOM\" set to \"1\"','172.21.0.1',NULL,NULL),
	(5,'2019-03-05 00:32:09','config','Site preference \"SESSION_TIME\" set to \"7200\"','172.21.0.1',NULL,NULL),
	(6,'2019-03-05 00:32:09','config','Site preference \"SMTP_ACTIVE\" set to \"internal\"','172.21.0.1',NULL,NULL),
	(7,'2019-03-05 00:32:09','config','Site preference \"SMTP_HOST\" set to \"localhost\"','172.21.0.1',NULL,NULL),
	(8,'2019-03-05 00:32:09','config','Site preference \"SMTP_PORT\" set to \"25\"','172.21.0.1',NULL,NULL),
	(9,'2019-03-05 00:32:09','config','Site preference \"SMTP_AUTH\" set to \"1\"','172.21.0.1',NULL,NULL),
	(10,'2019-03-05 00:32:09','config','Site preference \"SMTP_SSL\" set to \"none\"','172.21.0.1',NULL,NULL),
	(11,'2019-03-05 00:32:09','config','Site preference \"SMTP_HELO\" set to \"localhost\"','172.21.0.1',NULL,NULL),
	(12,'2019-03-05 00:32:09','config','Site preference \"SMTP_FROM_NAME\" set to \"localhost\"','172.21.0.1',NULL,NULL),
	(13,'2019-03-05 00:32:09','config','Site preference \"FV_SCHEMA_VERSION\" set to \"1\"','172.21.0.1',NULL,NULL),
	(14,'2019-03-05 00:32:09','config','Site preference \"FV_SCHEMA_VERSION\" set to \"2\"','172.21.0.1',NULL,NULL),
	(15,'2019-03-05 00:32:09','config','Site preference \"FV_SCHEMA_VERSION\" set to \"3\"','172.21.0.1',NULL,NULL),
	(16,'2019-03-05 00:32:09','config','Site preference \"FV_SCHEMA_VERSION\" set to \"4\"','172.21.0.1',NULL,NULL),
	(17,'2019-03-05 00:32:09','config','Site preference \"NB_SCHEMA_VERSION\" set to \"1\"','172.21.0.1',NULL,NULL),
	(18,'2019-03-05 00:32:09','config','Site preference \"NB_SCHEMA_VERSION\" set to \"2\"','172.21.0.1',NULL,NULL),
	(19,'2019-03-05 00:32:09','config','Site preference \"NB_SCHEMA_VERSION\" set to \"3\"','172.21.0.1',NULL,NULL),
	(20,'2019-03-05 00:32:09','config','Site preference \"WT_SCHEMA_VERSION\" set to \"1\"','172.21.0.1',NULL,NULL),
	(21,'2019-03-05 00:32:09','config','Site preference \"WT_SCHEMA_VERSION\" set to \"2\"','172.21.0.1',NULL,NULL),
	(22,'2019-03-05 00:32:09','config','Site preference \"WT_SCHEMA_VERSION\" set to \"3\"','172.21.0.1',NULL,NULL),
	(23,'2019-03-05 00:32:09','config','Site preference \"WT_SCHEMA_VERSION\" set to \"4\"','172.21.0.1',NULL,NULL),
	(24,'2019-03-05 00:32:09','config','Site preference \"WT_SCHEMA_VERSION\" set to \"5\"','172.21.0.1',NULL,NULL),
	(25,'2019-03-05 00:32:09','config','Site preference \"WT_SCHEMA_VERSION\" set to \"6\"','172.21.0.1',NULL,NULL),
	(26,'2019-03-05 00:32:09','config','Site preference \"WT_SCHEMA_VERSION\" set to \"7\"','172.21.0.1',NULL,NULL),
	(27,'2019-03-05 00:32:09','config','Site preference \"WT_SCHEMA_VERSION\" set to \"8\"','172.21.0.1',NULL,NULL),
	(28,'2019-03-05 00:32:09','config','Site preference \"WT_SCHEMA_VERSION\" set to \"9\"','172.21.0.1',NULL,NULL),
	(29,'2019-03-05 00:32:09','config','Site preference \"WT_SCHEMA_VERSION\" set to \"10\"','172.21.0.1',NULL,NULL),
	(30,'2019-03-05 00:32:09','config','Site preference \"WT_SCHEMA_VERSION\" set to \"11\"','172.21.0.1',NULL,NULL),
	(31,'2019-03-05 00:32:09','config','Site preference \"WT_SCHEMA_VERSION\" set to \"12\"','172.21.0.1',NULL,NULL),
	(32,'2019-03-05 00:32:09','config','Site preference \"WT_SCHEMA_VERSION\" set to \"13\"','172.21.0.1',NULL,NULL),
	(33,'2019-03-05 00:32:09','config','Site preference \"WT_SCHEMA_VERSION\" set to \"14\"','172.21.0.1',NULL,NULL),
	(34,'2019-03-05 00:32:09','config','Site preference \"WT_SCHEMA_VERSION\" set to \"15\"','172.21.0.1',NULL,NULL),
	(35,'2019-03-05 00:32:09','config','Site preference \"WT_SCHEMA_VERSION\" set to \"16\"','172.21.0.1',NULL,NULL),
	(36,'2019-03-05 00:32:09','config','Site preference \"WT_SCHEMA_VERSION\" set to \"17\"','172.21.0.1',NULL,NULL),
	(37,'2019-03-05 00:32:09','config','Site preference \"WT_SCHEMA_VERSION\" set to \"18\"','172.21.0.1',NULL,NULL),
	(38,'2019-03-05 00:32:09','config','Site preference \"WT_SCHEMA_VERSION\" set to \"19\"','172.21.0.1',NULL,NULL),
	(39,'2019-03-05 00:32:09','config','Site preference \"WT_SCHEMA_VERSION\" set to \"20\"','172.21.0.1',NULL,NULL),
	(40,'2019-03-05 00:32:09','config','Site preference \"WT_SCHEMA_VERSION\" set to \"21\"','172.21.0.1',NULL,NULL),
	(41,'2019-03-05 00:32:09','config','Site preference \"WT_SCHEMA_VERSION\" set to \"22\"','172.21.0.1',NULL,NULL),
	(42,'2019-03-05 00:32:09','config','Site preference \"WT_SCHEMA_VERSION\" set to \"23\"','172.21.0.1',NULL,NULL),
	(43,'2019-03-05 00:32:09','config','Site preference \"WT_SCHEMA_VERSION\" set to \"24\"','172.21.0.1',NULL,NULL),
	(44,'2019-03-05 00:32:09','config','Site preference \"WT_SCHEMA_VERSION\" set to \"25\"','172.21.0.1',NULL,NULL),
	(45,'2019-03-05 00:32:09','config','Site preference \"WT_SCHEMA_VERSION\" set to \"26\"','172.21.0.1',NULL,NULL),
	(46,'2019-03-05 00:32:09','config','Site preference \"WT_SCHEMA_VERSION\" set to \"27\"','172.21.0.1',NULL,NULL),
	(47,'2019-03-05 00:32:09','config','Site preference \"WT_SCHEMA_VERSION\" set to \"28\"','172.21.0.1',NULL,NULL),
	(48,'2019-03-05 00:32:09','config','Site preference \"WT_SCHEMA_VERSION\" set to \"29\"','172.21.0.1',NULL,NULL),
	(49,'2019-03-05 00:32:09','config','Site preference \"WT_SCHEMA_VERSION\" set to \"30\"','172.21.0.1',NULL,NULL),
	(50,'2019-03-05 00:32:09','config','Site preference \"WT_SCHEMA_VERSION\" set to \"31\"','172.21.0.1',NULL,NULL),
	(51,'2019-03-05 00:32:09','config','Site preference \"WT_SCHEMA_VERSION\" set to \"32\"','172.21.0.1',NULL,NULL),
	(52,'2019-03-05 00:32:09','config','Site preference \"WT_SCHEMA_VERSION\" set to \"33\"','172.21.0.1',NULL,NULL),
	(53,'2019-03-05 00:32:09','config','Site preference \"WT_SCHEMA_VERSION\" set to \"34\"','172.21.0.1',NULL,NULL),
	(54,'2019-03-05 00:32:09','config','Site preference \"WT_SCHEMA_VERSION\" set to \"35\"','172.21.0.1',NULL,NULL),
	(55,'2019-03-05 00:32:10','config','Site preference \"WT_SCHEMA_VERSION\" set to \"36\"','172.21.0.1',NULL,NULL),
	(56,'2019-03-05 00:32:10','config','Site preference \"WT_SCHEMA_VERSION\" set to \"37\"','172.21.0.1',NULL,NULL),
	(57,'2019-03-05 00:42:25','auth','Login: test/Test Admin','172.23.0.1',1,NULL),
	(58,'2019-03-05 00:42:27','config','Site preference \"LATEST_WT_VERSION\" set to \"1.7.12|1.0.0|https://github.com/fisharebest/webtrees/releases/download/1.7.12/webtrees-1.7.12.zip\"','172.23.0.1',1,NULL),
	(59,'2019-03-05 00:42:27','config','Site preference \"LATEST_WT_VERSION_TIMESTAMP\" set to \"1551746545\"','172.23.0.1',1,NULL),
	(60,'2019-03-05 00:43:02','config','Tree preference \"imported\" set to \"0\"','172.23.0.1',1,1),
	(61,'2019-03-05 00:43:02','config','Tree preference \"title\" set to \"TEST Mary Wade Family\"','172.23.0.1',1,1),
	(62,'2019-03-05 00:43:02','config','Tree preference \"CONTACT_USER_ID\" set to \"1\"','172.23.0.1',1,1),
	(63,'2019-03-05 00:43:02','config','Tree preference \"WEBMASTER_USER_ID\" set to \"1\"','172.23.0.1',1,1),
	(64,'2019-03-05 00:43:02','config','Tree preference \"LANGUAGE\" set to \"en-GB\"','172.23.0.1',1,1),
	(65,'2019-03-05 00:43:02','config','Tree preference \"SURNAME_TRADITION\" set to \"paternal\"','172.23.0.1',1,1),
	(66,'2019-03-05 00:43:03','config','Tree preference \"imported\" set to \"1\"','172.23.0.1',1,1);

/*!40000 ALTER TABLE `wt_log` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table wt_media
# ------------------------------------------------------------
...
# Dump of table wt_module_privacy
# ------------------------------------------------------------
...
INSERT INTO `wt_module_privacy` (`module_name`, `gedcom_id`, `component`, `access_level`)
VALUES
...
# Dump of table wt_module_setting
# ------------------------------------------------------------
...
INSERT INTO `wt_name` (`n_file`, `n_id`, `n_num`, `n_type`, `n_sort`, `n_full`, `n_surname`, `n_surn`, `n_givn`, `n_soundex_givn_std`, `n_soundex_surn_std`, `n_soundex_givn_dm`, `n_soundex_surn_dm`)
VALUES
	(1,'I1',0,'NAME','BLOGGS,Joe','Joe BLOGGS','BLOGGS','BLOGGS','Joe','J000','B420','100000:400000:500000','785400:784540:784000');

/*!40000 ALTER TABLE `wt_name` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table wt_news
# ------------------------------------------------------------
...
INSERT INTO `wt_other` (`o_id`, `o_file`, `o_type`, `o_gedcom`)
VALUES
	('HEAD',1,'HEAD','0 HEAD\n1 CHAR UTF-8\n1 DATE 5 Mar 2019'),
	('TRLR',1,'TRLR','0 TRLR');
...
INSERT INTO `wt_session` (`session_id`, `session_time`, `user_id`, `ip_address`, `session_data`)
VALUES
	('kmf2ao3i81ltfjvt73pvalj8av','2019-03-05 00:43:00',1,'172.23.0.1',X''),
	('ouv9oq0jhufbviagjruelp5rbd','2019-03-05 00:42:00',0,'172.23.0.1',X'');

/*!40000 ALTER TABLE `wt_session` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table wt_site_access_rule
# ------------------------------------------------------------
...
INSERT INTO `wt_site_access_rule` (`site_access_rule_id`, `ip_address_start`, `ip_address_end`, `user_agent_pattern`, `rule`, `comment`, `updated`)
VALUES
	(1,0,4294967295,'Mozilla/5.0 (%) Gecko/% %/%','allow','Gecko-based browsers','2019-03-05 00:32:09'),
	(2,0,4294967295,'Mozilla/5.0 (%) AppleWebKit/% (KHTML, like Gecko)%','allow','WebKit-based browsers','2019-03-05 00:32:09'),
	(3,0,4294967295,'Opera/% (%) Presto/% Version/%','allow','Presto-based browsers','2019-03-05 00:32:09'),
	(4,0,4294967295,'Mozilla/% (compatible; MSIE %','allow','Trident-based browsers','2019-03-05 00:32:09'),
	(5,0,4294967295,'Mozilla/5.0 (% Konqueror/%','allow','Konqueror browser','2019-03-05 00:32:09'),
	(6,0,4294967295,'Mozilla/% (Windows%; Trident%; rv:%) like Gecko','allow','Modern Internet Explorer','2019-03-05 00:32:09'),
	(7,0,4294967295,'Mozilla/5.0 (Mobile; Windows Phone 8.1; % Microsoft; %','allow','Windows Phone 8.1','2019-03-05 00:32:09');

/*!40000 ALTER TABLE `wt_site_access_rule` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table wt_site_setting
# ------------------------------------------------------------
...
VALUES
	...
	('LATEST_WT_VERSION','1.7.12|1.0.0|https://github.com/fisharebest/webtrees/releases/download/1.7.12/webtrees-1.7.12.zip'),
	('LATEST_WT_VERSION_TIMESTAMP','1551746545'),
	('NB_SCHEMA_VERSION','3'),
	('SESSION_TIME','7200'),
...
VALUES
	...
	(1,'test','Test Admin','test@marywadefamily.org','$2y$10$ZYCPAQ.V4f70mAdVxtJjNeqjEkEHMWVjNnShQppHXLKCBtPZ2ee82');

/*!40000 ALTER TABLE `wt_user` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table wt_user_gedcom_setting
# ------------------------------------------------------------
