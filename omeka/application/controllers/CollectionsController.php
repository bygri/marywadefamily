...
// AMENDED BY TG 29-03-2018 to default the ordering on the Collections page to alphabetical rather than
// by date of addition. This file is valid as of Omeka-2.7. See lines 122-125.
// Check for changes at https://github.com/omeka/Omeka/blob/master/application/controllers/CollectionsController.php
...
class CollectionsController extends Omeka_Controller_AbstractActionController
{
    ...
    {
// BEGIN TG AMENDMENT
        return array('Dublin Core,Title', 'a');
