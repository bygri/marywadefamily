...
WORKDIR /build
# Fetch applications
RUN curl -LO https://github.com/omeka/Omeka/releases/download/v3.0.3/omeka-3.0.3.zip \
  -O https://github.com/fisharebest/webtrees/releases/download/2.1.7/webtrees-2.1.7.zip
